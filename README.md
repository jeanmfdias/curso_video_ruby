# Lista de Exercícios do Curso em Vídeo do Guanabara [Edição Ruby]

Exercícios no curso do Guanabara são resolvidos em Python nesse repositório irei resolver em **Ruby**
